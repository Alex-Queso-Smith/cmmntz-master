...
RSpec.describe Api::V1::UnblockingsController, type: :controller do
  describe 'while authenticated do' do
    ...
    # UnblockingsController. Be sure to keep this updated too.
    let(:valid_session) { {} }

    describe "POST #create" do
      context "with valid params" do
        it "finds and destroys the correct blocking" do
          Blocking.create(valid_attributes)
            expect {
